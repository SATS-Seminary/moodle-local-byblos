                ...
                [
                    ...
                    'configdata' => json_encode([
                        ...
                        'skills' => [
                            ...
                            ['name' => 'Qualitative research', 'level' => 4],
                            ['name' => 'Public speaking', 'level' => 4],
                            ['name' => 'Collaboration & facilitation', 'level' => 5],
                            ['name' => 'Digital tools (Office, Moodle, Zotero)', 'level' => 4],
                            ['name' => 'Second language (French, intermediate)', 'level' => 3],
                        ],
                    ]),
                    'content' => '',
                ],
            ...
            'sections' => [
                ...
                [
                    ...
                    'configdata' => json_encode([
                        ...
                        'skills' => [
                            ['name' => 'Product design (Figma)', 'level' => 5],
                            ['name' => 'Frontend (React, TypeScript)', 'level' => 4],
                            ['name' => 'User research & testing', 'level' => 4],
                            ['name' => 'Accessibility (WCAG 2.2 AA)', 'level' => 4],
                        ],
                    ]),
                    'content' => '',
                ],
            ...
            'sections' => [
                ...
                [
                    ...
                    'configdata' => json_encode([
                        'heading' => 'Core skills',
                        'skills' => [
                            ['name' => 'Programme & project management', 'level' => 5],
                            ['name' => 'Stakeholder & vendor management', 'level' => 5],
                            ['name' => 'Learning experience design', 'level' => 5],
                            ['name' => 'Data-informed decision-making', 'level' => 4],
                            ['name' => 'Facilitation & coaching', 'level' => 4],
                            ['name' => 'Moodle, Articulate, Figma', 'level' => 4],
                        ],
                    ]),
                    'content' => '',
                ],
