...
/**
 * Fired when a user creates a new portfolio page.
 *
 * @package    local_byblos
 * @copyright  2026 South African Theological Seminary
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class page_created extends base {
    ...
    public static function get_name(): string {
        return get_string('event_page_created', 'local_byblos');
    }
    ...
    public function get_description(): string {
        return "The user with id '{$this->userid}' created a portfolio page with id '{$this->objectid}'.";
    }
